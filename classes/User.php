...
class User{
    ...
    <strong>Fields must not be empty</strong>
         ...
         echo "<div class=\"alert alert-danger alert-dismissible\">
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
    <strong>Name must contain only letters and spaces.</strong></div>";
          exit();
      }elseif (strlen($userName) < 3 || strlen($userName) > 20) {
         echo "<div class=\"alert alert-danger alert-dismissible\">
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
    <strong>Username must be between 3 and 20 characters.</strong></div>";
          exit();
      }elseif (!preg_match("/^[a-zA-Z0-9]*$/", $userName)) {
         echo "<div class=\"alert alert-danger alert-dismissible\">
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
    <strong>Username can only contain numbers and letters.</strong></div>";
          exit();
      }elseif (!preg_match("/^(?=.*[a-zA-Z])(?=.*\d)(?=.*[^a-zA-Z\d\s])\S{6,}$/", $password)) {
         echo "<div class=\"alert alert-danger alert-dismissible\">
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>
    <strong>Password must be at least 6 chars and include letters, numbers, and special chars without spaces.</strong></div>";
          exit();
